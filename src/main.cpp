/*
 *  Project 32-button-led - main.cpp
 *
...
static String output_led1_state = "off";        // Variable to store present LED state

/*
 *  Definitions included in platformio.ini
 *      LED             GPIO for "LED"
 *      LED_OFF         Which is the level for LED off
 *      SERIAL_BAUD     Serial Baud rate
 */

//  Other definitions

#define LED_ON !LED_OFF     //  Define LED_ON as complementary of LED_OFF
